...
function TimelineSent(props) {
  ...
  const handleEmitData = (data) => {
    props.onPressTimelineSent(data);
  };
  ...
  return (
    <View style={styles.timelineSent}>
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 60 }}>
            {
              timelineData.map((item, itemIndex) => (
                <View style={styles.timelineSentContent} key={itemIndex}>
...
export default memo(TimelineSent);